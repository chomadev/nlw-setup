...
export function NewHabitForm() {
    ...
    const handleForm = function(event: FormEvent) {
    ...
    const handleWeekDaysChanged = function(weekDay: number) {
        const isChecked = weekDays.includes(weekDay);
        if (isChecked) {
            ...
            <div className="flex flex-col gap-2 mt-3">
                {
                    availableWeekDays.map((day, index) => (
                        <Checkbox.Root
                            ...
                            onCheckedChange={e => handleWeekDaysChanged(index)}
                        ...
                        >
                            ...
                            <span className="text-white leading-tight group-data-[state=checked]:font-semibold">
                                {day}
                            </span>
                        </Checkbox.Root>
                    ))
